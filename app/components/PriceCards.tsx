      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {formats.map((format) => (
          ...
          >
            {/* Badge de sélection */}
            {selectedFormat === format.id && (
              <div className="absolute -top-2 -right-2 bg-gradient-to-r from-green-400 to-green-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold shadow-lg">
                ✓
              </div>
            )}
